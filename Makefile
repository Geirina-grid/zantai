...
ifeq ($(TARGET_ARCH),aarch64)
  $(info >>> WARNING - cuSolverDn_LinearSolver is not supported on aarch64 - waiving sample <<<)
  SAMPLE_ENABLED := 0
endif
...
cuSolverDn_LinearSolver.o:CA.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
...
cuSolverDn_LinearSolver: Utilities.o cuSolverDn_LinearSolver.o mmio.c.o mmio_wrapper.o
